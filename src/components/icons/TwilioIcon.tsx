...
interface TwilioIconProps {
  className?: string;
  size?: number;
}

/**
 * Logo Twilio — path do [Simple Icons](https://simpleicons.org/) (CC0).
 * Removido do pacote npm em versões recentes; mantido aqui a partir do ícone oficial do projeto.
 */
const TWILIO_PATH =
...
export function TwilioIcon({ className, size = 24 }: TwilioIconProps) {
  return (
    <svg
      ...
      aria-label="Twilio"
    >
      <path fill="currentColor" d={TWILIO_PATH} />
    </svg>
  );
}
